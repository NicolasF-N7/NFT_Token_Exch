...
contract TokenManagerMetadata is TokenManager, ERC721Metadata{
  string private __name;
  string private __symbol;
  bytes private __uriBase;//nexchange = neighbor exchange = next exchange = next change

  constructor(string memory _name, string memory _symbol, string memory _uriBase) public TokenManager(){
    __name = _name;
    __symbol = _symbol;
